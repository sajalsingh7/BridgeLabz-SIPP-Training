...
public class Bank {
 public static void main(String[] args) {
     SavingsAccount savings = new SavingsAccount("123", 100000, 5);
     CheckingAccount checking = new CheckingAccount("456", 50000, 200000);
     FixedDepositAccount fixed = new FixedDepositAccount("789", 250000, 10);
